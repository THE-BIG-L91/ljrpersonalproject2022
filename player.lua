...
function Player:load()
   ...
   self.hurtSound = love.audio.newSource("assets/sfx/player_hit.wav", "static")
...
function Player:shoot()
   if self.grounded == true and self.canShoot == true then
      x, y = self.physics.body:getPosition()
      new_Bullet = bullet.new(x,y-6,self.direction,5,"player")
      new_Bullet:fire()
   end
end
